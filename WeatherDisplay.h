...
#define VERSION  "14.2"        // Version number of the software
...
#define HWVERSION "2.0"        // Version number of the hardware
#else
#define ALIVE_LED D3           // Flashes to indicate that the system is alive
#define HWVERSION "1.0"        // Version number of the hardware
#endif
