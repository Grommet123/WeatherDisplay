...
const char* ssid     = "gkgrotsky"; // SSID of local network
const char* password = "780BD1335F"; // Password on network
String APIKEY = "da60a6008eaa324a47c9e2064a27a217";
String CityID = "4364537"; // MD
...
//int TimeZone = 2; //GMT +/- Your local time offset
